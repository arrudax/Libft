...
/*   Updated: 2024/11/12 21:55:26 by maanton2         ###   ########.org.br   */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function behaves similarly to the standard `calloc` function.
 * It allocates
 * the requested memory and clears it to ensure that the memory is initialized
 * to zero, which can prevent undefined behavior when using
