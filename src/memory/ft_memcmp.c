...
/*   Updated: 2024/11/12 21:53:42 by maanton2         ###   ########.org.br   */
/*                                                                            */
/* ************************************************************************** */
 ...
 * to the first n bytes of the memory area pointed to by s2. It returns
 * an integer
 * less than, equal to, or greater than zero if the first n bytes
 * of s1 are found,
 ...
 * the first n bytes
 *         of s1 are found to be less than, to match, or be greater than
 *         the first n
